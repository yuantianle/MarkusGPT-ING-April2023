...
//Here are three functions. 
  //The first one is used to fetch the response from the server. 
  ...
  //The second one is used to set the state of the chat and then send the message to the server.
  ...
  //The third one is used to send the message to the server and then set the state of the chat.
