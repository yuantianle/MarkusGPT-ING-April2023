...
//`chat` prop is an array of objects that contains the messages that are sent to the chat body component. The `chat` prop is passed down from the App.jsx component.
const ChatBody = ({chat}) => {
